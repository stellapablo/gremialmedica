...
//$_SESSION['KCFINDER']['uploadURL'] = URL::to('assets/images');//'../../imagen';
//$_SESSION['KCFINDER']['uploadDir'] = URL::to('assets/images');//'../../imagen';

echo URL::to('assets/images');
echo "<br>";
...
$( document ).ready( function(){
 ...
 $( '#pruebajq' ).ckeditor().on( 'getData.ckeditor', function( event, editor, data ) {
  ...
  $( '#pruebajq2' ).ckeditor().on( 'getData.ckeditor', function( event, editor, data ) {
     // If you want to convert the data to upper case whenever you get a value.
     data.dataValue = data.dataValue.toUpperCase();
    // alert(data.dataValue.toUpperCase());
     //alert(this.id)
...
//editor.on( 'configLoaded', function() {
//    
//        editor.config.filebrowserBrowseUrl = '/imagen/browse.php?type=Images';
//        editor.config.filebrowserUploadUrl = '/uploader/upload.php?type=Files';
//        });
//    });
...
<div id="container">
	<div id="header">
		<div id="headerLeft">
			...
			<h3 contenteditable="true" id="pruebajq2">
				Lorem ipsum dolor sit amet dolor duis blandit vestibulum faucibus a, tortor.
			</h3>
		</div>
		<div id="headerRight">
			<div id="pruebajq" contenteditable="true">
				<p>
					a Lorem ipsum dolor sit amet enim. Etiam ullamcorper. Suspendisse a pellentesque dui, non felis. Maecenas malesuada elit lectus felis, malesuada ultricies.
				</p>
				<p>
	...
	<div id="columns">
		...
		<div id="column3">
			<div contenteditable="true">
				<p>
					<img src="{{ asset('assets/librerias/ckeditor/samples/assets/inlineall/logo.png') }}" alt="CKEditor logo" style="float:left">
				</p>
...
<div id="footer">
	...
	<p id="copy" contenteditable="true">
