...
<div class="panel-body">
    <div class="row">
        <div class="col-lg-4">
            {{ Form::model($afiliado, array('method' => 'PATCH', 'route' => array('afiliados.update', $afiliado->id))) }}
            ...
            <div class="form-group">
                ...
                {{ link_to_route('afiliados.show', 'Cancel', $afiliado->id, array('class' => 'btn')) }}
            </div>
        </div>
        <div class="col-lg-4">
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="observaciones" class="form-control">{{ $afiliado->observaciones }}</textarea>
            </div>
