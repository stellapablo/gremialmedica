...
<section id="content">
    <div class="wrap-content zerogrid">
        <div class="row block05">
            <div class="title" id="titulo_principal" contenteditable="true" >{{ $contacto->titulo_principal  }}</div>
            <div class="col-2-3">
                <div class="wrap-col">
                    <article>
                        ...
                        <div class="info" id="subtitulo_principal_descripcion" contenteditable="true">
                            {{ $contacto->subtitulo_principal_descripcion  }}
                        </div>
                ...
                <div class="wrap-col">
                    <div class="box">
                        <div class="heading" id="titulo_derecha_primero" contenteditable="true">
                            {{ $contacto->titulo_derecha_primero  }}
                        </div>
                    ...
                    <div class="box">
                        <div class="heading" id="titulo_derecha_segundo" contenteditable="true">
                            {{ $contacto->titulo_derecha_segundo  }}
                        </div>
                        <div class="content">
...
[
    ...
    $(document).ready(function() {
        ...
        $('#titulo_principal').ckeditor().on('getData.ckeditor', function(event, editor, data) {
            CKEDITOR.config.saveSubmitURL = 'actualizarContacto';
        });
